...
const ContactForm: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6">
      <div className="bg-black/50 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-12 md:p-16 shadow-[0_50px_100px_rgba(0,0,0,0.6)] relative overflow-hidden">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/40 text-lg font-light italic">Descubre cómo GrowMED puede optimizar tu crecimiento clínico.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="text-xs font-black text-white/30 uppercase tracking-[0.2em] ml-1">Nombre</label>
                <input 
                  required
                  type="text" 
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-white/30 uppercase tracking-[0.2em] ml-1">Correo</label>
                <input 
                  required
                  type="email" 
            ...
            <div className="space-y-2">
              <label className="text-xs font-black text-white/30 uppercase tracking-[0.2em] ml-1">Especialidad</label>
              <input 
                required
                type="text" 
                placeholder="Ej. Cardiología, Medicina Estética..."
                className="w-full bg-white/[0.03] border border-white/10 focus:border-primary/50 focus:bg-white/[0.08] transition-all rounded-2xl px-6 py-4 outline-none text-lg"
              />
            </div>
