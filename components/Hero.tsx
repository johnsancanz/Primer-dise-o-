...
const Hero: React.FC = () => {
  return (
    <section className="relative flex flex-col items-center justify-center pt-24 pb-48 text-center px-6 overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center">
        {/* Logotipo Centrado encima de la frase - Aumentado a text-7xl */}
        ...
        {/* Párrafo descriptivo - Reducido a text-base md:text-lg */}
        <p className="text-base md:text-lg text-white/50 max-w-2xl mb-16 leading-relaxed font-light relative z-20">
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-center justify-center relative z-20">
